                    ...
                    ->form([
                        Forms\Components\Section::make('Datos generales')
                            ...
                            ->schema([
                                ...
                                Forms\Components\TextInput::make('limpieza_periodontal')->label('Limpieza periodontal')->maxLength(255),
                                Forms\Components\TextInput::make('fluor')->label('Flúor')->maxLength(255),
                        ...
                        Forms\Components\Section::make('III. Diagnóstico clínico y radiográfico (formato de hoja)')
                            ->schema([
                                Forms\Components\Grid::make(['default' => 2, 'md' => 4])->schema([
                                    ...
                                    Forms\Components\Placeholder::make('gap_e1')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Forms\Components\Placeholder::make('gap_e2')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Group::make()->schema([
                                        Forms\Components\Textarea::make('dx.2_8')->label('2.8')->rows(2),
                                    ...
                                    Forms\Components\Placeholder::make('gap_e3')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Forms\Components\Placeholder::make('gap_e4')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Group::make()->schema([
                                        Forms\Components\Textarea::make('dx.2_7')->label('2.7')->rows(2),
                                    ...
                                    Forms\Components\Placeholder::make('gap_e5')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Forms\Components\Placeholder::make('gap_e6')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Group::make()->schema([
                                        Forms\Components\Textarea::make('dx.2_6')->label('2.6')->rows(2),
                                    ...
                                    Forms\Components\Placeholder::make('gap_e7')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Forms\Components\Placeholder::make('gap_e8')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Group::make()->schema([
                                        Forms\Components\Textarea::make('dx.4_6')->label('4.6')->rows(2),
                                    ...
                                    Forms\Components\Placeholder::make('gap_e9')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Forms\Components\Placeholder::make('gap_e10')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Group::make()->schema([
                                        Forms\Components\Textarea::make('dx.4_7')->label('4.7')->rows(2),
                                    ...
                                    Forms\Components\Placeholder::make('gap_e11')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Forms\Components\Placeholder::make('gap_e12')->label('')->content(' ')->extraAttributes(['class' => 'hidden md:block']),
                                    Group::make()->schema([
                                        Forms\Components\Textarea::make('dx.4_8')->label('4.8')->rows(2),
