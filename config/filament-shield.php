...
return [
    ...
    */
    ...
    'super_admin' => [
        'enabled' => true,
        'name' => 'super_admin',
        // Vía Gate::before: el rol super_admin tiene acceso total sin
        // necesitar todas las filas de permisos asignadas en la BD.
    ...
    */
    ...
    /*
     * ⚠️ COMPATIBILIDAD v3: la BD de producción ya tiene permisos en formato
     * snake_case con guion bajo (view_any_cliente) y las Policies los chequean
     * con esos nombres literales. NO cambiar separator/case sin migrar los
     * registros de la tabla permissions y todas las Policies a la vez.
     */
    'permissions' => [
        'separator' => '_',
        'case' => 'snake',
    ...
    */
    ...
    'resources' => [
        ...
        'exclude' => [
            // Igual que en v3: UserResource no se gestiona vía Shield
